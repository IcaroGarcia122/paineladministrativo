...
import { t as require_detect_libc } from "./detect-libc+unenv.mjs";
import processModule from "node:process";
//#region node_modules/vite/node_modules/lightningcss/node/browserslistToTargets.js
...
//#endregion
//#region node_modules/vite/node_modules/lightningcss/node/composeVisitors.js
...
//#endregion
//#region node_modules/vite/node_modules/lightningcss/node/flags.js
...
//#endregion
//#region node_modules/vite/node_modules/lightningcss/node/index.js
var require_node = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var parts = [processModule.platform, processModule.arch];
	if (processModule.platform === "linux") {
		const { MUSL, familySync } = require_detect_libc();
		if (familySync() === MUSL) parts.push("musl");
		else if (processModule.arch === "arm") parts.push("gnueabihf");
		else parts.push("gnu");
	} else if (processModule.platform === "win32") parts.push("msvc");
	var native;
	try {
...
//#endregion
//#region node_modules/vite/node_modules/lightningcss/node/index.mjs
...
var { transform, transformStyleAttribute, bundle, bundleAsync, browserslistToTargets, composeVisitors, Features } = (/* @__PURE__ */ __toESM(require_node(), 1)).default;
//#endregion
export { node_exports as t };
